...
minuto = int(input("Informe o minuto atual em sua máquina: "))
resultado = minuto

for x in range(minuto-1):
    resultado = resultado * (minuto-1)
    minuto = minuto - 1

print("A senha do minuto atual é LIBERDADE{}.".format(resultado))
